 ...
 */
public class ExplodeString2 extends GenericUDTF {
    ...
    public StructObjectInspector initialize(StructObjectInspector argOIs) throws UDFArgumentException {
        ...
        if (allStructFieldRefs.size() != 2) {
            throw new UDFArgumentException("需要2参数");
        }
    ...
    public void process(Object[] args) throws HiveException {
        ...
        String sregex = String.valueOf(args[1]);
        String[] split = fieldone.split(sregex);
        for (String s : split) {
            arrayList.clear();
            String[] kvs = s.split(":");
            String kv = kvs[0];
